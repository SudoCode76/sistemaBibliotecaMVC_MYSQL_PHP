...
<body>
    <div class="login-container">
        ...
        <div class="input-container">
            <form action="../../controllers/loginControllers/loginCliente/loginAction.php" method="post" class="input-container">
            ...
            <a href="loginEmpleado.php" class="btn btn-outline btn-error">Soy Empleado</a>
